            ...
            <div className="w-full max-w-6xl bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
                    ...
                    <div className="relative z-10 w-full h-full flex flex-col justify-between">
                        ...
                        <motion.div variants={itemVariants}>
                            ...
                            <p className="text-xl text-white opacity-90 mb-8 max-w-md">
                                Visualize your note-taking journey with our intuitive analytics.
                            </p>
                        </motion.div>
                ...
                >
                    <motion.div variants={itemVariants}>
                        ...
                        <p className="text-gray-600 mb-8">Access your notes and continue your work</p>
                    </motion.div>
                    ...
                    >
                        <p className="text-sm text-gray-600">
                            ...
                            <Link to={'/signin'} className="font-medium text-indigo-600 hover:text-indigo-500 transition-colors duration-200">
                                Sign up
                            </Link>
                        </p>
                    </motion.div>
